...
async function saveFee(){
    ...
    // If Firestore never responds (blocked network, ad-blocker,
    // offline, etc.) this makes sure the user sees a message
    // instead of the page just silently doing nothing forever.
    const stuckWarning = setTimeout(() => {
        alert(
            ...
            "network may be blocking Firebase (googleapis.com / " +
            "gstatic.com)."
        );
    }, 8000);
